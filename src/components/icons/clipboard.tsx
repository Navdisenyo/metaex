  ...
  return (
    ...
    >
      <rect
        ...
        rx="3"
        className={clsx(
          'dark:group-hover:fill-[#fff6c7] transition-all dark:fill-[#464033] fill-[#bbbbba] group-hover:fill-[#ffd406]',
          { 'dark:!fill-[#fffac7] fill-[#ffd406] ': selected }
        )}
      />
      <path
        ...
        className={clsx(
          'dark:group-hover:fill-[#ffd754] transition-all dark:fill-[#C0BFC4] fill-[#666559] group-hover:fill-[#ffe68a] ',
          { 'dark:!fill-[#ffd406] fill-[#fff18a] ': selected }
        )}
      />
      <path
        fillRule="evenodd"
