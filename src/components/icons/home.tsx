  ...
  return (
    ...
    >
      <path
        ...
        className={clsx(
          'dark:group-hover:fill-[#fdffc7] transition-all dark:fill-[#464033] fill-[#c4c3bf] group-hover:fill-[#ffd406]',
          { 'dark:!fill-[#fffbc7] !fill-[#e8c204] ': selected }
        )}
      />
      <path
        d="M9 16C9 14.8954 9.89543 14 11 14H13C14.1046 14 15 14.8954 15 16V22H9V16Z"
        className={clsx(
          'dark:group-hover:fill-[#ffd406] transition-all dark:fill-[#c4c3bf] fill-[#5B5966] group-hover:fill-[#ffd406] ',
          { 'dark:!fill-[#ffd406] fill-[#9c8202]': selected }
        )}
      />
    </svg>
  )
